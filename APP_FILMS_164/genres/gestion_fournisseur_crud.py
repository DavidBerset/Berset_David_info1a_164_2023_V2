    ...
    if request.method == "POST":
        try:
            if form.validate_on_submit():
                ...
                strsql_insert_fournisseur = """INSERT INTO t_fournisseur (id_fournisseur,nom_fournisseur) VALUES (NULL,%(value_intitule_genre)s) """
...
def genre_update_wtf():
    ...
    try:
        ...
        if form_update.validate_on_submit():
            ...
            str_sql_update_intitulegenre = """UPDATE t_fournisseur SET nom_fournisseur = %(value_name_genre)s, 
            ...
            str_sql_id_genre = "SELECT id_fournisseur, nom_fournisseur FROM t_fournisseur " \
                               "WHERE id_fournisseur = %(value_id_genre)s"
